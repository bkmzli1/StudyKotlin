 ...
 */
fun lengthInMeters(sagenes: Int, arshins: Int, vershoks: Int): Double = 4.445 * (48 * sagenes + 16 * arshins + vershoks)
 ...
 */
fun angleInRadian(grad: Int, min: Int, sec: Int): Double = Math.PI * (grad / 180 + min / (180 * 60) + sec / (180 * 60 * 60))
